...
Options:
  ...
  --action-timeout <ms>      Timeout for browser actions in milliseconds (or AGENT_BROWSER_ACTION_TIMEOUT)
...
Environment:
  ...
  AGENT_BROWSER_ACTION_TIMEOUT   Timeout for browser actions in milliseconds
